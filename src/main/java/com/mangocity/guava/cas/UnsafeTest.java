...
public class UnsafeTest {
	...
	@Test
	public void testAllocate() throws Exception{//FileDescriptor
		Unsafe u = fetchInstance();
		//long s = u.allocateMemory(1);
		//System.out.println(s);
		
		//Object obj = (Object) u.allocateInstance(Object.class);
	...
	public void testCAS() throws Exception {
		Unsafe u = fetchInstance();
		long offSet = u.objectFieldOffset(HashMap.class.getDeclaredField("threshold"));
	...
	@Test
	public void testTheUnsafe() throws SecurityException, NoSuchFieldException, IllegalArgumentException,
